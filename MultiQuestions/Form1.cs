...
namespace MultiQuestions
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            Loading.updateControlForm += LoadItemsStripMenu;
            Loading.LoadGroup();
            DefStat();
        }
        ...
        {
            int i = -1;
            questionToolStripMenuItem.DropDownItems.Clear();

            for (int y = 0; y < Loading.Groups.Count; y++)
            {
                ToolStripMenuItem item = new ToolStripMenuItem(Loading.Groups[y].NameGroup);
                questionToolStripMenuItem.DropDownItems.Add(Loading.Groups[y].NameGroup);
